...
// Bespoke generated images for Sally's Legal Apparel
import robeMannequinImg from '../assets/images/court_robe_mannequin_1788766580436.jpg';
import shirtEditorialImg from '../assets/images/court_formal_shirt_1788766624725.jpg';
import wigBandsImg from '../assets/images/wig_and_bands_editorial_1788766600740.jpg';
import heroAdvocateImg from '../assets/images/hero_legal_advocate_1788766557023.jpg';
import advocateStarterBundleImg from '../assets/images/advocate_starter_bundle_1788768175887.jpg';
import counselBriefcaseImg from '../assets/images/counsel_leather_briefcase_1788768192069.jpg';
import advocateBarJacketImg from '../assets/images/advocate_bar_jacket_1788768212087.jpg';
import femaleCourtJabotImg from '../assets/images/female_court_jabot_1788768238134.jpg';
import judicialBenchRobeImg from '../assets/images/judicial_bench_robe_1788768253246.jpg';
import courtRobeNavyImg from '../assets/images/court_robe_navy_1788771917618.jpg';
import courtRobeGreyImg from '../assets/images/court_robe_grey_1788771933358.jpg';
import briefcaseBlackImg from '../assets/images/briefcase_black_1788771948678.jpg';
import briefcaseTanImg from '../assets/images/briefcase_tan_1788771962335.jpg';

export const HERO_IMAGE = heroAdvocateImg;
export const ROBE_HERO = robeMannequinImg;
export const SHIRT_HERO = shirtEditorialImg;
export const WIG_HERO = wigBandsImg;
export const STARTER_BUNDLE_HERO = advocateStarterBundleImg;
export const BRIEFCASE_HERO = counselBriefcaseImg;
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    images: [
      shirtEditorialImg,
      'https://images.unsplash.com/photo-1620012253295-c15c429f6d4d?q=80&w=1200&auto=format&fit=crop'
    ],
    colours: [
  ...
  },
  {
    ...
    colours: [
      { name: 'Midnight Navy', hex: '#161F2E', image: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?q=80&w=1200&auto=format&fit=crop' },
      { name: 'Graphite Charcoal', hex: '#262626', image: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?q=80&w=1200&auto=format&fit=crop' },
      { name: 'Classic Jet Black', hex: '#0B0B0C', image: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?q=80&w=1200&auto=format&fit=crop' }
    ],
  ...
  },
  {
    ...
    colours: [
      { name: 'Advocate Royal Blue', hex: '#1A2B49', image: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?q=80&w=1200&auto=format&fit=crop' },
      { name: 'Senior Counsel Red', hex: '#631322', image: 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?q=80&w=1200&auto=format&fit=crop' }
    ],
  ...
  },
  {
    ...
    colours: [
      { name: 'Crisp White', hex: '#FFFFFF', image: shirtEditorialImg }
    ],
  ...
  },
  {
    ...
    colours: [
      { name: '18K Gold Vermeil', hex: '#C5A880', image: 'https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?q=80&w=1200&auto=format&fit=crop' },
      { name: 'Rhodium Silver', hex: '#D8D8DC', image: 'https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?q=80&w=1200&auto=format&fit=crop' }
    ],
    sizes: ['One Size (18mm)'],
    inStock: true,
    featured: false,
  ...
  },
  {
    ...
    colours: [
      { name: 'Court White', hex: '#FFFFFF', image: femaleCourtJabotImg }
    ],
  ...
  },
  {
    ...
    colours: [
      { name: 'Polished Brass', hex: '#D4AF37', image: 'https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?q=80&w=1200&auto=format&fit=crop' },
      { name: 'Silver Nickel', hex: '#C0C0C0', image: 'https://images.unsplash.com/photo-1617038260897-41a1f14a8ca0?q=80&w=1200&auto=format&fit=crop' }
    ],
  ...
  },
  {
    ...
    images: [
      advocateStarterBundleImg,
      robeMannequinImg,
      wigBandsImg,
      shirtEditorialImg
    ],
    colours: [
      { name: 'Ceremonial Black & White', hex: '#0E0E10', image: advocateStarterBundleImg }
    ],
  ...
  },
  {
    ...
    colours: [
      { name: 'Black & Gold Filigree', hex: '#1C1B1A', image: advocateStarterBundleImg }
    ],
...
export const CATEGORIES = [
  {
    id: 'robes',
    name: 'COURT ROBES',
    description: 'Professional robes and courtroom attire.',
    categoryKey: 'Court Robes',
    image: judicialBenchRobeImg,
    badge: 'Senior & Junior Counsel'
  },
  {
    id: 'shirts',
    name: 'COURT SHIRTS',
    description: 'Formal shirts designed for legal professionals.',
    categoryKey: 'Court Shirts',
    image: shirtEditorialImg,
  ...
  },
  {
    ...
    categoryKey: 'Suits & Formalwear',
    image: advocateBarJacketImg,
    badge: 'Savile-Cut Wool'
  },
  {
    id: 'wigs-bands',
    name: 'WIGS & BANDS',
    description: 'Traditional and modern legal accessories.',
    categoryKey: 'Wigs',
    image: wigBandsImg,
    badge: 'Handcrafted Tradition'
  }
];

export const LOOKBOOK_IMAGES = [
  {
    url: advocateStarterBundleImg,
    title: 'The Admittance Package',
    subtitle: 'Barathea Robe, Barrister Wig & Tin Regalia',
    span: 'col-span-12 md:col-span-7 row-span-2'
  },
  {
    url: judicialBenchRobeImg,
    title: 'Bench & Appellate Majesty',
    subtitle: 'Pure Damask Silk & Rosette Sleeves',
    span: 'col-span-12 md:col-span-5'
  },
  {
    url: counselBriefcaseImg,
    title: 'Florentine Counsel Briefcase',
    subtitle: 'Full-Grain Vegetable-Tanned Brass Lock',
    span: 'col-span-12 md:col-span-5'
  },
  {
    url: femaleCourtJabotImg,
    title: 'Feminine Court Decorum',
    subtitle: 'French Floral Lace Court Jabot & Bib',
    span: 'col-span-12 md:col-span-6'
  },
  {
    url: advocateBarJacketImg,
    title: 'Chambers Horseshoe Waistcoat',
    subtitle: 'Savile-Row Tropical Wool Bar Vest',
    span: 'col-span-12 md:col-span-6'
  }
];
...
export const SOCIAL_POSTS = [
  {
    image: advocateStarterBundleImg,
    caption: 'Official admittance ceremonial package for newly sworn Advocates. Complete with Barathea gown and horsehair wig. @sallys_legal_apparel',
    likes: '2,840'
  },
  {
    image: judicialBenchRobeImg,
    caption: 'Judicial damask silk bench robe handcrafted for High Court ceremony. Uncompromising craftsmanship.',
    likes: '1,984'
  },
  {
    image: counselBriefcaseImg,
    caption: 'Solid brass twin-lock counsel litigation briefcase. Handcrafted in vegetable-tanned Florentine leather.',
    likes: '1,450'
  },
  {
    image: femaleCourtJabotImg,
    caption: 'Hand-fluted female advocate court bib with delicate French lace jabot. Chambers refinement.',
    likes: '2,110'
  },
  {
    image: advocateBarJacketImg,
    caption: 'Three-piece advocate horseshoe waistcoat and bar jacket. Cut to showcase court bands effortlessly.',
    likes: '1,720'
  },
  {
    image: wigBandsImg,
    caption: 'Hand-tied English horsehair barrister wigs in custom engraved metal carriage tins. Delivered across East Africa.',
    likes: '3,210'
  }
];
